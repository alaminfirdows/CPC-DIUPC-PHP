...
<html lang="en">
  ...
  <body>
    ...
    <section class="login-content">
      <div class="logo">
        <a class="" href="<?php echo $settings['url']; ?>index"><img src="<?=base_url('assets');?>/img/logo.png" alt="Stage 4 Cancer Community" style="height: 40px;"/></a>
      </div>
      <?php
        $responce = get_flush_data('register_responce');
      ...
      <div class="login-box" style="min-height: 650px">
        <form action="" method="POST" id="login_form" class="login-form">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" placeholder="Enter username" id="username" name="username" required autofocus>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" placeholder="Enter lastName" id="lastName" name="lastName">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="control-label">REPREAT PASSWORD</label>
            <input class="form-control" type="password" id="re_password" name="re_password" placeholder="Password" required>
          </div>
          <div class="form-group btn-container">
            <button class="btn btn-primary btn-block" type="submit" id="register" name="register" ><i class="fa fa-sign-in fa-lg fa-fw"></i>SIGN UP</button>
          </div>
        </form>
